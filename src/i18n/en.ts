...
const lang = {
  ...
  vote: {
    ...
    how_to_vote: "We will vote on the nomination works and select the excellent works.. You can post your favorite work one person at a time. To vote, you need to hold one of the following NFT.",
