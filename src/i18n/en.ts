...
const lang = {
  ...
  vote: {
    title: "NounsArtFestival2022 Vote! (under preparation)",
    ...
    how_to_vote: "We will vote for the nominated works. Please post your favorite work one person at a time. To vote, you need to hold one of the following NFT.",
