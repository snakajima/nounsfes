...
const lang = {
  ...
  vote: {
    title: "NounsArtFestival2022 Nomination Vote!",
    ...
    how_to_vote: "We will vote on the submitted works and select the nomination. You can post your favorite work one person at a time. To vote, you need to hold one of the following NFT.",
