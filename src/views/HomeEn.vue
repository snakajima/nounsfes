  ...
  <div class="max-w-lg mx-auto text-left p-2">
    ...
    <div class="space-y-2 font-pt-root">
      <ul>
        ...
        <li class="ml-4 -indent-4"><b class="font-londrina">Prizes:</b> 5eth + $25,000 (we are raising more from other sponsors)</li>
        ...
        <li class="ml-4 -indent-4"><b class="font-londrina">Secondary Use:</b>
        ...
        <li class="ml-4 -indent-4"><b class="font-londrina">Inspiring Video Examples:</b> 
